...
<nav class="navbar navbar-default  container-fluid" style="background-color:#b3e0ff;margin-bottom: 0!important; " role="navigation">
    ...
    <div class="row  "style="background-color:#b3e0ff "  >
        ...
        <img class="col-sm-1 container " width="50px"  height="130px" style="float: right;overflow: hidden; margin-top:0%" src="img/DMC (1).png"/>
    </div>
    ...
    <div class="navbar-header">
        <!--   <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
               ...
               <span class="icon-bar">yudghgdh</span>
           </button>-->
...
<div class="row " id="contain">
    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 navbar_both"  >



        <table class="btn-group-vertical ">

            <tr > <button type="button" class="btn btn-default btn-block">Internal messaging</button> </tr>
            <tr > <button type="button" class="btn btn-default btn-block">Connect stakeholders</button> </tr>
            <tr > <button type="button" class="btn btn-default btn-block">Daily Report</button> </tr>
            <tr > <button type="button" class="btn btn-default btn-block">Contacts</button> </tr>
            <tr > <button type="button" class="btn btn-default btn-block">xdg</button> </tr>
            ...
            <tr > <button type="button" class="btn btn-default btn-block">Advanced options</button> </tr>
        </table>
    </div>
    ...
    <div class="col-lg-8 col-sm-12 col-xs-12 col-md-10 ">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-sm-offset-1 col-lg-6 col-md-offset-3 col-md-6 col-lg-offset-3 col-xs-10 admin_msg_win" >
                ...
                <form action="" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div style="margin-top: 10px;">
                            ...
                            <!--   <ul class="list-group">
                                   <li class="list-group-item "> staff<input type="checkbox">  </li>
                                   <li class="list-group-item "> officers<input type="checkbox"  >  </li>
                                   <li class="list-group-item "> Gauge Rangers<input type="checkbox" >  </li>
                                   <li class="list-group-item "> Public<input type="checkbox" >  </li>
                               </ul>-->
                        </div>
                    </div>
